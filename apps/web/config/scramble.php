...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Read the OPAL material library: search materials, fetch variants with their representations and file URLs, and resolve platform references such as Revit material names back to library variants.',
    ],
