...
@php
    ...
    $navigation = array_values(array_filter([
        ...
        ['route' => 'dashboard', 'match' => 'dashboard', 'label' => __('Workspaces'), 'index' => '03', 'show' => true],
        ['route' => 'profile.edit', 'match' => 'profile.edit|security.edit', 'label' => __('Settings'), 'index' => '04', 'show' => true],
