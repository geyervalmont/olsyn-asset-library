...
final class ProceduralRecipes
{
    ...
    public static function defaults(string $generator): array
    {
        return match ($generator) {
            ...
            'masonry' => ['unit_width_mm' => 230, 'unit_height_mm' => 76, 'joint_mm' => 10, 'bond' => 'running', 'unit_colours' => ['#B2593E', '#974530', '#C2704F'], 'joint_colour' => '#CDCAC0', 'roughness' => 0.68, 'edge_depth_mm' => 3, 'tone_variation' => 0.12],
    ...
    public static function rules(string $generator): array
    {
        ...
        return match ($generator) {
            ...
            'masonry' => ['recipe.unit_width_mm' => $positive, 'recipe.unit_height_mm' => $positive, 'recipe.joint_mm' => ['required', 'numeric', 'gte:0'], 'recipe.bond' => ['required', 'in:stack,running,quarter'], 'recipe.unit_colours' => ['required', 'array', 'min:1', 'max:8'], 'recipe.unit_colours.*' => $colour, 'recipe.joint_colour' => $colour, 'recipe.roughness' => $unit, 'recipe.edge_depth_mm' => ['required', 'numeric', 'gte:0'], 'recipe.tone_variation' => $unit],
