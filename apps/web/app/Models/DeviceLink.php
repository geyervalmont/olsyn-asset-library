...
class DeviceLink extends Model
{
    ...
    {
        $client = in_array($this->client, ['prismfs', 'nucleus-drive'], true) ? ($this->client === 'nucleus-drive' ? 'OPAL Nucleus Drive' : 'OPAL Drive') : Str::of($this->client)->replace(['-', '_'], ' ')->title()->toString();
